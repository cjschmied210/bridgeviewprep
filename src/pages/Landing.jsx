            ...
            >
                ...
                <div className="flex bg-academic-100 rounded-xl p-1 mb-8 relative">
                    <button
                        ...
                        className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all duration-300 ${view === 'student' ? 'bg-white shadow-[0_4px_12px_rgba(245,158,11,0.15)] text-blue-950 border-b-2 border-amber-500' : 'text-academic-500 hover:text-academic-700'}`}
                    >
                        Student Join
                    </button>
                    <button
                        onClick={() => setView('teacher')}
                        className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all duration-300 ${view === 'teacher' ? 'bg-white shadow-[0_4px_12px_rgba(245,158,11,0.15)] text-blue-950 border-b-2 border-amber-500' : 'text-academic-500 hover:text-academic-700'}`}
                    >
                        Teacher Login
                    </button>
                </div>
