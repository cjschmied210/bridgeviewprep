                        ...
                        <div className="py-2.5 px-4 md:px-6 border-b border-academic-100 flex flex-col gap-1.5 bg-white/50 shrink-0">
                            ...
                            <div className="flex gap-1 mt-0.5">
                                {testConfig.questions.map((_, i) => (
                                    <div key={i} className={`h-1.5 w-6 rounded-full transition-all duration-300 ${i === currentQ ? 'bg-gradient-to-r from-blue-400 to-primary shadow-[0_0_8px_rgba(37,99,235,0.4)]' : i < currentQ ? 'bg-primary/50' : 'bg-academic-200'}`} />
                                ))}
                            </div>
                        </div>
                                ...
                                >
                                    ...
                                    <div className="space-y-2 shrink min-h-0 overflow-y-auto custom-scrollbar">
                                        {question.options.map(opt => {
                                            ...
                                            if (mode === 'exam') {
                                                if (isSelected) {
                                                    btnState = 'border-primary bg-primary text-white shadow-[0_4px_12px_rgba(37,99,235,0.2)] hover:bg-blue-600 hover:border-blue-600 scale-[0.99]';
